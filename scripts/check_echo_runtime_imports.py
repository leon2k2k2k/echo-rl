...
REQUIRED_DISTS = [
    ...
    "uvicorn",
    "vllm-router",
    # vLLM runtime deps. These are installed/checklisted separately because
    # vLLM itself was installed --no-deps to avoid Torch/CUDA drift.
    "anthropic",
    "blake3",
    "cachetools",
    "cbor2",
...
REQUIRED_IMPORTS = [
    ...
    ("model_hosting_container_standards", "model-hosting-container-standards"),
    ("numba", "numba"),
    ("openai_harmony", "openai-harmony"),
    ("cv2", "opencv-python-headless"),
    ("outlines_core", "outlines-core"),
